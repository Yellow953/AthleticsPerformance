                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="io" id="io" class="form-control" required>
                                        @foreach ($ios as $io)
                                        <option value="{{$io->io}}" {{$event->io == $io->io ? 'selected' :
                                            ''}}>{{$io->io}}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" id="distance" name="distance" placeholder="Distance"
                                class="form-control" value="{{$event->distance}}">
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="checkbox">
                                <label for="heat" class="form-check-label ">
                                    <input type="checkbox" id="heat" name="heat" class="form-check-input" {{$event->heat
                                    ? 'checked' : ''}}>Heat
                                </label>
                            </div>
                        </div>
