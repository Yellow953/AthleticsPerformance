    ...
    <div class="row">
        <div class="col-md-12">
            <div class="overview-wrap">
                <h2 class="title-1 text-yellow">Statistics</h2>
            ...
            <div class="overview-item overview-item--c1">
                <div class="overview__inner">
                    <div class="overview-box clearfix">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" class="mr-1 my-auto"
                                fill="white" class="bi bi-calendar3" viewBox="0 0 16 16">
                                <path
            ...
            <div class="overview-item overview-item--c2">
                <div class="overview__inner">
                    <div class="overview-box clearfix">
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" class="mr-1 my-auto"
                                fill="white" class="bi bi-cone-striped" viewBox="0 0 16 16">
                                <path
