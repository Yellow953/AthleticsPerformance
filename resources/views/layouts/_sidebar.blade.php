    ...
    <div class=" menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                <li>
                    <a href="{{ route('home') }}"
                        class="{{ request()->is('/') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                ...
                <li>
                    <a href="{{ route('athletes') }}"
                        class="{{ request()->is('athletes', 'athletes/new', 'athletes/*/edit') ? 'text-primary' : 'text-white' }}  d-flex nav-link">
                        ...
                        </svg><span class="my-auto">Athletes</span></a>
                </li>
                <li>
                    <a href="{{ route('competitors') }}"
                        class="{{ request()->is('competitors', 'competitors/new', 'competitors/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-person-square mr-4 my-auto" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path
                                d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z" />
                        </svg><span class="my-auto">Competitors</span></a>
                </li>
                <li>
                    <a href="{{ route('meetings') }}"
                        class="{{ request()->is('meetings', 'meetings/new', 'meetings/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                        ...
                        </svg><span class="my-auto">Meetings</span></a>
                </li>
                <li>
                    <a href="{{ route('events') }}"
                        class="{{ request()->is('events', 'events/new', 'events/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                        ...
                        </svg><span class="my-auto">Events</span></a>
                </li>
                <li>
                    <a href="{{ route('results') }}"
                        class="{{ request()->is('results', 'results/new', 'results/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                            fill="currentColor" class="bi bi-bar-chart-fill" viewBox="0 0 16 16">
                            <path
                                d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z" />
                        </svg><span class="my-auto">Results</span></a>
                </li>
                <li>
                    <a href="{{ route('records') }}"
                        class="{{ request()->is('records', 'records/new', 'records/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                        ...
                        </svg><span class="my-auto">Records</span></a>
                </li>
                <li>
                    <a href="{{ route('reports') }}"
                        class="{{ request()->is('reports') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                        ...
                        </svg><span class="my-auto">Reports</span></a>
                </li>
                <li>
                    <a href="{{ route('users') }}"
                        class="{{ request()->is('users', 'users/new', 'users/*/edit') ? 'text-primary' : 'text-white' }} d-flex nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-4 my-auto"
                            fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                            <path
                                d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                        </svg><span class="my-auto text-uppercase">Users</span></a>
                </li>
            </ul>
        </nav>
    </div>
